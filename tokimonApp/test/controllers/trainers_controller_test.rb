...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { level: @trainer.level, tname: @trainer.tname, tokimon_id: @trainer.tokimon_id } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { level: @trainer.level, tname: @trainer.tname, tokimon_id: @trainer.tokimon_id } }
